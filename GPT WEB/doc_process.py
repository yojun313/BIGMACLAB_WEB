...
class doc_process:
    def __init__(self): 
        self.pdf_folder_path = "C:/Users/User/Documents/GPT WEB/pdf_storage/"
        self.pdf_statement_folder_path = "C:/Users/User/Documents/GPT WEB/pdf_statement_storage/"
        self.storage_json = 'C:/Users/User/Documents/GPT WEB/public/storage.json'
...
# 인증 파일 경로
    ...
    def word_download(self, word_url):
        ...
        word_folder_path = "C:/Users/qwe/Desktop/VSCODE/GPT WEB/docx_storage"
        if not os.path.exists(word_folder_path):
            os.makedirs(word_folder_path)

        word_file_name = file_name + '.docx'
        word_file_path = os.path.join(word_folder_path, word_file_name)
    ...
    def word_statement_download(self, word_url):
        ...
        word_folder_path = "C:/Users/qwe/Desktop/VSCODE/GPT WEB/docx_statement_storage"
        if not os.path.exists(word_folder_path):
            os.makedirs(word_folder_path)
    ...
    def pdf_statement_download(self, pdf_id): # pdf_id 입력하면 다운로드
        ...
        pdf_folder_path = "C:/Users/qwe/Desktop/VSCODE/GPT WEB/pdf_statement_storage"
        if not os.path.exists(pdf_folder_path):
            os.makedirs(pdf_folder_path)
...
# C:/Users/qwe/Desktop/VSCODE/GPT WEB/pdf_storage/text.pdf
# C:/Users/qwe/Desktop/VSCODE/GPT WEB/docx_storage/고소장 표준 양식(경찰청).docx
