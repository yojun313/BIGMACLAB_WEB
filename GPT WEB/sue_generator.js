...
const python_suegenerator = 'C:/Users/User/Documents/GPT WEB/sue_generator.py';
const python_save_doc = 'C:/Users/User/Documents/GPT WEB/save_doc.py';
const python_save_statement_doc = 'C:/Users/User/Documents/GPT WEB/save_statement_doc.py';
const python_admin_system_process = 'C:/Users/User/Documents/GPT WEB/admin_system_process.py';
const python_statement_generator = 'C:/Users/User/Documents/GPT WEB/statement_generator.py';
const result_page_html = 'C:/Users/User/Documents/GPT WEB/public/result_page.html'
const statement_result_page_html = 'C:/Users/User/Documents/GPT WEB/public/statement_result_page.html'
const admin_system_ejs = 'C:/Users/User/Documents/GPT WEB/views/admin_system.ejs'
...
app.get('/gpt', (req, res) => {
    ...
    const pythonProcess = spawn('python', [python_suegenerator, JSON.stringify(first_formData), JSON.stringify(second_formData)]);
...
app.get('/save', (req, res) => {
  ...
  const pythonProcess = spawn('python', [python_save_doc, req.session.doc_edit_url]);
...
app.get('/admin_system', (req, res) => {
  const pythonProcess = spawn('python', [python_admin_system_process]);
...
app.get('/statement', (req, res) => {
  const pythonProcess = spawn('python', [python_statement_generator, globalWordname]);
...
app.get('/statement_save', (req, res) => {
  ...
  const pythonProcess = spawn('python', [python_save_statement_doc, req.session.statement_doc_edit_url]);
...
app.listen(port, '0.0.0.0', () => {
  console.log(`[ GPT 고소장 서버 ]\n- 서버가 http://121.152.225.232:112/ 에서 실행 중입니다.`);
});